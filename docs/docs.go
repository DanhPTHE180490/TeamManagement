    ...
    "paths": {
        ...
        "/api/folders": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Example: {'name': 'Project Documents'}",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/notes": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Example: {'title': 'Note Title', 'content': 'Note content', 'folder_id': 2}",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/notes/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Example: {'title': 'New Title', 'content': 'Updated content', 'folder_id': 2}",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/notes/{id}/share": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Example: {'user_id': 2, 'permission': 'read'}",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/teams/": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Team Name (e.g., {'name': 'My Team'})",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/teams/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated Team Name (e.g., {'name': 'Updated Team Name'})",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/teams/{id}/members": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "User ID (e.g., {'user_id': 123})",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/auth/login": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Example: {'email': 't@t.com', 'password': '123'}",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/auth/register": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Example: {'username': 'test', 'email': 't@t.com', 'password': '123', 'role': 'manager'}",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
